...
const rBlock = `let systemInstructions = '';
      try {
        systemInstructions = fs.readFileSync(path.join(process.cwd(), 'docs', 'System_instructions_AI_Studio.md'), 'utf-8');
      } catch (e) {
...
if (!code.includes('import * as fs')) code = "import * as fs from 'fs';\n" + code;
